...
class LeePelserProfile extends AbstractProfile
{
    ...
    {
        return "I'm that guy...<br />" .
                "<script>alert('🍺👊🏻');</script>" .
                "<script>console.log('That Guy Fucks')</script>" .
    ...
    {
        return 'https://thecommunity.co.za/user_avatar/thecommunity.co.za/zeroth/240/10_1.png';
    }
